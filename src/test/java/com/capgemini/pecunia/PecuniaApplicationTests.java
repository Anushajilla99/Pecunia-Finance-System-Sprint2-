...
public void AccountCreationTest() {
	Account ac=new Account(111111,"Archana",100.0,"road1","road2","Telangana","Hyderabad","India",503123,765432189,989789056,04/01/1998);
	when(dao4.accountCreation(ac)).thenReturn(ac);
	assertEquals(ac,dao4.accountCreation(ac));
}
@Test
public void testUpdateAccount() {
	Account ac=new Account(111,"Archana",100.0,"road1","road2","Telangana","Hyderabad","India",503123,765432189,989789056,2020/09/23);
	dao4.update(ac);
    verify(dao4,times(1)).update(ac);
}*/
